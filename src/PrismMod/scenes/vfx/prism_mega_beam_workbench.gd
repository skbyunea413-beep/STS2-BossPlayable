...
@export_range(0.0, 1.80, 0.01) var preview_time: float = 0.52
...
func _draw() -> void:
	var from: Vector2 = Vector2(160.0, 360.0)
	var to: Vector2 = Vector2(beam_length, 312.0)
