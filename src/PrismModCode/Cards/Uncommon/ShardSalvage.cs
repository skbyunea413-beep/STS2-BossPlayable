...
public sealed class ShardSalvage : PrismCard
{
    public override string? CustomPortraitPath => $"{MainFile.ResPath}/images/card_portraits/shardsalvage.png";
    ...
    public ShardSalvage() : base(1, CardType.Skill, CardRarity.Uncommon, TargetType.Self) { }
