...
Prism currently uses direct attack pressure, generated cards from other character pools, and Exhaust-pile payoffs, with custom boss and ancient-event interactions.
